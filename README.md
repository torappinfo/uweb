...
- <a href="https://uwebzh.netlify.app/en/search/index.html" onclick="{let u=location.href; if(u.endsWith('index.html'))location='../../en/search/index.html'}">newbing/chatgpt</a> for censored area
