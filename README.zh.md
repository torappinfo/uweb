...
- <a href="zh/search.md" onclick="if(notRepo()){location='../search/index.html#';return false;}">AI聊天可作为搜索引擎</a>，界面针对AI及传统搜索智能优化，地址栏首字母为空格开启自动补全输入法。复杂问询如代码可选择文件[作为键盘输入](https://uwebzh.netlify.app/zh/input/index.html#)，主屏输入框"空格+换行"开头时以"地址栏+输入框"为有效查询，可以地址栏为资料汇聚中心。
- 微：不到250K。
